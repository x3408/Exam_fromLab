                    ...
                    $.each(quesions, function (index, item) {
                        ...
                        if(quesions[index].questionType==0){
                            ...
                            selectQuestionObj +='<div class="problem selectIndex">' +
                                ...
                                '<ul class="answer">' +
                                '<li>A、<input type="checkbox" name="select'+selectNum+'" id="" value="A" onclick="judgeScope(this)"/><span>'+quesions[index].alternativeOption1+'</span></li>' +
                                '<li>B、<input type="checkbox" name="select'+selectNum+'" id="" value="B" onclick="judgeScope(this)"/><span>'+quesions[index].alternativeOption2+'</span></li>' +
                                '<li>C、<input type="checkbox" name="select'+selectNum+'" id="" value="C" onclick="judgeScope(this)"/><span>'+quesions[index].alternativeOption3+'</span></li>' +
                                '<li>D、<input type="checkbox" name="select'+selectNum+'" id="" value="D" onclick="judgeScope(this)"/><span>'+quesions[index].alternativeOption4+'</span></li></ul></div>';
                            total += 1;
                        } else{
                            judgeNum = judgeNum + 1;
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.success){
                    ...
                    gradeList[3].innerText="判断题得分："+data.obj.packScore+"分";
